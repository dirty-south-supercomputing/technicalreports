...
O(1)\footnote{Data page: Metadata page index - 31 + inode number within page.}, as can the
inode corresponding to a data
page\footnote{Inode page: Page index OR 0x1fu. Inode number: Page index MOD 32.}),
