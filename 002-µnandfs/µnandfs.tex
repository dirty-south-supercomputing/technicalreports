...
the most effective solution for retention errors.
...
\begin{center}
\includegraphics[width=1\linewidth]{ReadBlob.png}
\captionof{figure}{\texttt{ReadBlob} state machine}
\end{center}
...
\captionof{figure}{\texttt{Format}, \texttt{Fsck}, and \texttt{Sync} state machines}
\end{center}
