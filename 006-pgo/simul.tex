\chapter{Simulation}
\label{chap:simul}
This chapter is somewhat technical, and can be skipped by readers
...
This process is repeated many times, with more repetitions required for more
 ...
 one run, since it ought generate the same path every time. As the number of
...
Nonetheless, this is $\mathcal{O}(144^N)$ time for $N$ turns.
