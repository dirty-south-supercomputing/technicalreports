...
If we want to do this, we'd better prune this game tree using
 limited expert methods\footnote{We remain exhaustive, rather than
 stochastic, just within a limited space. Our output remains
...
Given the timing advice provided in \autoref{chap:strategy}, we will permit
 ...
 \textit{and} the Pokémon's fast attack cannot fit within the opponent's
  remaining turns throwing said fast attack,
...
\begin{code}
\captionof{listing}{Death march simulation pseudocode}
