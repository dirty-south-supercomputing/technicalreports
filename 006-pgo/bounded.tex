...
Essentially, we want to model the relationship between opponents' potential $Eff_D$
 stats and our potential $Eff_A$ \textbf{FIXME exact stat from earlier equations}.
Due to the floor function used in the damage equation, damage inflicted is typically
 staggered across these values.
\textbf{FIXME}
