...
\autoref{subsec:cp1500g} lists species' optimal level and IVs for the Great League
...
\autoref{subsec:cp2500g} does the same for the Ultra League, eliding those species which
...
The spread of damage is greater for Earthquake than Megahorn (17 versus 9), a ratio
  of 1.\textoverline{8}, significantly more than the ratio of Earthquake (with STAB)
  to Megahorn (1.31).
