...
\centering
  \begin{minipage}[t]{0.5\textwidth}
    \includegraphics[width=.5\textwidth,keepaspectratio]{images/greninjalevels.png}
  \end{minipage}
  \begin{minipage}[t]{0.5\textwidth}
    \includegraphics[width=.5\textwidth,keepaspectratio]{images/greninjagmeans.png}
  \end{minipage}
\caption{Contours of optimal Greninja levels and resulting geometric means.\\
  (X axis is $IV_A$, Y axis is $IV_D + IV_S$)}
\label{fig:contours}
\end{figure}
%\textbf{FIXME need graph of contour plot of optimal frontier.
