...
A fast attack is defined by its type, duration, power, and the energy built up with each use (\autoref{table:fastattacks3x3});
  these values (aside from type) can differ between 3x3 and Nx1 battles.
...
It is also the only five turn attack, and the only one to hit 4 (without STAB) on both \EPT{} and \PPT{}\@.
Razor Leaf stands alone with a \PPT{} of 4.5, with Force Palm coming in behind it at 4.33.
Lock On manages 5 \EPT{}, Water Shuriken 4.67, with Psycho Cut, Poison Sting, Fairy Wind, Karate Chop,
  Ember, and Thunder Shock at 4.5.
...
The type is persisted across trades and TMs, but not across evolution.

\begin{figure}[ht]
\includegraphics[keepaspectratio,width=\textwidth]{out/pptvst.pdf}
  \caption{\PPT{} vs turns for fast attacks\label{fig:pptvst}}
\end{figure}

\begin{figure}[hb]
\includegraphics[keepaspectratio,width=\textwidth]{out/eptvst.pdf}
...
A charged attack is defined for 3x3 by its type, power, and the energy it consumes (\autoref{table:chargedattacks});
...
%\footnote{Meteorites are available from Research/events, and Mega Rayquaza raids.}.
...
\begin{figure}[ht]
\includegraphics[keepaspectratio,width=\textwidth]{out/dpevse.pdf}
...
Adventure effects cost Stardust, Candy, and/or Mega Energy appropriate to the Pokémon
...
Roar of Time & Origin Forme Dialga & 5 & 6\\
  \multicolumn{4}{l}{\textit{Pause incense, Lucky Egg, and Star Piece timers}}\\
Spacial Rend & Origin Forme Palkia & 5 & 10\\
  \multicolumn{4}{l}{\textit{Encounter wild Pokémon at greater distance}}\\
Ice Burn & White Kyurem & 5 & 10\\
  \multicolumn{4}{l}{\textit{Slow down catch circles, +50\% to catch rate}}\\
Freeze Shock & Black Kyurem & 5 & 10\\
  \multicolumn{4}{l}{\textit{Stop movement in encounters, +25\% to catch rate}}\\
Sunsteel Strike & Dusk Mane Necrozma & 3 & 10\\
  \multicolumn{4}{l}{\textit{Spawn and evolve daytime Pokémon}}\\
Moongeist Beam & Dawn Wings Necrozma & 3 & 10\\
  \multicolumn{4}{l}{\textit{Spawn and evolve evening Pokémon}}\\
Behemoth Blade & Crowned Sword Zacian & 5 & 6\\
  \multicolumn{4}{l}{\textit{+10\% to ATK in raids, +5\% in Max Battles}}\\
Behemoth Bash & Crowned Shield Zamazenta & 5 & 6\\
  \multicolumn{4}{l}{\textit{+10\% to DEF in raids, +5\% in Max Battles}}\\
Dynamic Punch+ & Mega Mewtwo X & 75/5 & 10 \\
  \multicolumn{4}{l}{\textit{Break two shields in Super Mega Raids}}\\
Future Sight+ & Mega Mewtwo Y & 75/5 & 12 \\
  \multicolumn{4}{l}{\textit{Reveal Pokémon with high stats (3$\star$+ (\autoref{sec:ivs}))}}\\
Dynamax Cannon & Eternatus & 5/30 & 10\\
  \multicolumn{4}{l}{\textit{Boost Max Move levels by 1 for true Max Pokémon and Eternatus}}\\
\end{tabular}
\caption[Adventure effects of charged attacks]{Adventure effects of charged attacks. Costs are expressed in units of 1,000 Stardust and Candy.\label{table:adveffects}}
\end{table}
...
In Max Battles, it can be beneficial to eschew charged attacks completely;
...
% got this number via 'cat out/*full* | grep -v begin | grep -v \\end | wc -l'
10,234 combinations of fast and charged attack are currently in play.
...
``Legacy'' attacks (\autoref{table:eliteelite}) cannot be acquired even
...
\Midrule
Chansey                 & Psybeam      & Incarnate Tornadus      & Bleakwind Storm\\
Lugia                   & Aeroblast+   & Incarnate Thundurus     & Wildbolt Storm\\
Ho-Oh                   & Sacred Fire+ & Incarnate Landorus      & Sandsear Storm\\
White Kyurem            & Ice Burn     & Rayquaza                & Dragon Ascent \\
Black Kyurem            & Freeze Shock & Dawn Wings Necrozma     & Moongeist Beam\\
Tapu Koko               & Zap Cannon   & Dusk Mane Necrozma      & Sunsteel Strike\\
Palkia                  & Spacial Rend & Crowned Zacian    & Behemoth Blade\\
Dialga                  & Roar of Time & Crowned Zamazenta& Behemoth Bash\\
\end{tabular}
\caption{Legacy attacks not available via Elite TMs\label{table:eliteelite}}
\end{table}
\input{out/elite}
