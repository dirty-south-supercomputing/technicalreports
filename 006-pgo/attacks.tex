...
\begin{table}
  ...
  \end{tabular}
  \caption{Adventure effects of charged attacks}
  \label{table:adveffects}
\end{table}
...
Indeed, due to a charged attack immediately concluding an opponent's fast attack,
 it is technically possible to lose by throwing a shielded charged attack, when
