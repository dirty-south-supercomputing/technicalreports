...
\begin{table}
\centering
\begin{tabular}{lp{.4\textwidth}ll}
Attack & Effect & Cost & Time\\
\Midrule
Roar of Time & Pause incense, Lucky Egg, and Star Piece timers & 5 & 6\\
Spacial Rend & Encounter wild Pokémon at greater distance & 5 & 10\\
Ice Burn & Slow down catch circles, +50\% to catch rate & 5 & 10\\
Freeze Shock & Stops movement in encounters, +25\% to catch rate & 5 & 10\\
Sunsteel Strike & Spawn and evolve daytime Pokémon & 3 & 10\\
Moongeist Beam & Spawn and evolve evening Pokémon & 3 & 10\\
Behemoth Blade & +10\% to ATK in raids, +5\% in Max Battles & 5 & 6\\
Behemoth Bash & 10\% to DEF in raids, +5\% in Max Battles & 5 & 6\\
\end{tabular}
\caption[Adventure effects of charged attacks]{Adventure effects of charged attacks. Cost is expressed in units of Candy and 1,000 Stardust.\label{table:adveffects}}
\end{table}
