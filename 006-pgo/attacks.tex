...
A fast attack is defined by its duration, its power, and the energy it builds up.
\textbf{group by duration}
...
A charged attack is defined by its power, and the energy it consumes.
Energy generated by the Fast Attack goes into a pool from which either Charged Attack can draw.

\textbf{group by energy consumption}
