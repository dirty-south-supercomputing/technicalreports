...
For CP1500, when a form can max out, i.e.\ is not restricted by the CP bound,
%(\autoref{subsec:cp1500a}, \autoref{subsec:cp1500g})
  the maximum advantage tends to be 10\%--25\%, with a few outliers around 50\%.
It otherwise quickly drops to 4\% or less.
%(\autoref{subsec:cp2500a}, \autoref{subsec:cp2500g}),
In CP2500, the advantage available from IVs is even smaller, as we would expect.
