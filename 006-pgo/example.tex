...
Fighting and Ground are neutral against the third type (Water), while Grass is ineffective
...
Something like Rock.
Rock is ineffective against Steel, but neutral against our other two cores.
...
We're ineffective against anything with Steel except for Steel/Ground, Steel/Rock, and Steel/Water, which
  Grass can hit for neutral damage.
...
We do no better than neutral against 17 (6.4\%), and both attacks are
...
Unfortunately, there are no Grass attacks on Blastoise, though
  ...
  will do at least neutral damage to just about everyone.
