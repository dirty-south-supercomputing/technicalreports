...
\begin{align}
  P_C &= 1-(1 - \frac{C}{2\times{}CPM}^{M_C})\\
  M_C &= M_{Ball} \times M_{Berry} \times M_{Throw} \times M_{Medal} \times M_{AdvEff} \times M_{Enc}
\end{align}
\begin{itemize}
...
\item $M_{AdvEff}$ is 1.5 for Ice Burn, 1.25 for Freeze Shock, and 1 otherwise.
