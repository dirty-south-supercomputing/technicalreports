...
\begin{table}[ht]
  \begin{center}
    \begin{tabular}{lcp{.75\textwidth}}
      ...
      Golden Lure & \includegraphics[width=\textwidth]{images/goldenlure.png} & Attracts Roaming Form Gimmighoul\newline Gimmighoul Coins from spins \newline Extra items from spins\\
      Mystery Box & \includegraphics[width=\textwidth]{images/mysterybox.png} & Attracts Meltan\\
    \end{tabular}
  \end{center}
...
%  \begin{minipage}[t]{0.3\textwidth}
%    \begin{center}
%    \includegraphics[width=\textwidth]{images/glaciallure.png}
%    \end{center}
...
%  \begin{minipage}[t]{0.3\textwidth}
%    \begin{center}
%    \includegraphics[width=\textwidth]{images/magneticlure.png}
%    \end{center}
...
%  \begin{minipage}[t]{0.3\textwidth}
%    \begin{center}
%    \includegraphics[width=\textwidth]{images/goldenlure.png}
%    \end{center}
%    \caption*{Golden lure}
