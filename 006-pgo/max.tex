...
\section{Crowned forms \includegraphics[width=1em,height=1em]{images/crownenergy.png}}
\label{sec:crowned}
...
Crowning consumes 1,000 Crown Energy, but once a Pokémon has been crowned,
  ...
  forms\footnote{I'm not sure why one would uncrown. My best guess is to change one's charged attack.}.
\input{out/crowned}
