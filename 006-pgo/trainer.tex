...
\begin{wrapfigure}{l}{.25\textwidth}
  \center
  \includegraphics[width=.25\textwidth]{images/luckyegg.png}
  \caption*{Lucky Egg}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{.25\textwidth}
  \center
  \includegraphics[width=.25\textwidth]{images/stardust.png}
  \caption*{Stardust}
\end{wrapfigure}
...
\begin{wrapfigure}{l}{.25\textwidth}
  \center
  \includegraphics[width=.25\textwidth]{images/starpiece.png}
  \caption*{Star Piece}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{.25\textwidth}
  \center
  \includegraphics[width=.25\textwidth]{images/rarecandy.png}
  \caption*{Rare Candy}
\end{wrapfigure}
A Pokémon can be ``transferred to the Professor'' for soul harvesting;
  ...
  Pokémon cannot be harvested\footnote{At the very least: Kubfu,
  Marshadow, Celebi, Mew, Shaymin, Victini, Meloetta, Keldeo, Jirachi, Diancie, Zarude, Zygarde,
  and Volcanion.}).
...
\begin{wrapfigure}{l}{.25\textwidth}
  \center
  \includegraphics[width=.25\textwidth]{images/rarecandyxl.png}
