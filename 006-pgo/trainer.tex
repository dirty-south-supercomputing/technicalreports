...
Level upgrades (\autoref{table:levelupgrades}) add another 350.
Maximum storage of 11,500 Pokémon thus requires Level 80 and 43,400 Pokécoins.
...
The Bag can be upgraded to store up to 11,650 items.
Here again, each upgrade costs 200 Pokécoins, and increases capacity by 50 items.
Storage awards due to level upgrades (\autoref{table:levelupgrades}) add another 750.
The maximum Bag, with space for 11,650 items, thus requires Level 80 and 40,600 Pokécoins.
...
\begin{itemize}
  ...
  \item \textbf{Today:} Field research---short-term (usually) tasks acquired by spinning Photo Discs.
    ...
    A Pokéstop will not assign more than one field research per day.
