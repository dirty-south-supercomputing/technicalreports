...
There is a large set of Medals (most of them functionally meaningless), each of which can be achieved at the Bronze,
 Silver, Gold, or Platinum level. \textbf{FIXME some ohave effects on premier balls}
\begin{longtable}{lm{.3\textwidth}rrrr}
...
\Midrule
  ...
  Hero & GO Rocket Grunt and Leader wins & 10 & 100 & 1k & 2k\\
...
\end{tabular}
\end{table}
Certain medals associated with catching Pokémon of a type give capture rate bonuses
