...
\begin{itemize}
  \item \textit{Catch \textrm{N} Pokémon}. The Pokémon can be the same species.
    Catches after raids, Max Battles, and research count.
    Hatching does not count.
    Evolution and form change do not count.
    Trades do not count.
  \item \textit{Power up \textrm{N} Pokémon}. Powering up the same Pokémon $M$ times counts for $M$.
     ...
     does not count.
   \item \textit{Evolve \textrm{N} Pokémon}.
      Evolving the same Pokémon twice counts as two evolutions.
      Form change does not count.
    \item \textit{Catch \textrm{N typelist} Pokémon}. See \textit{Catch \textrm{N} Pokémon} above.
     ...
     \item \textit{Power up \textrm{N typelist} Pokémon}. See \textit{Power up \textrm{N} Pokémon}
       and \textit{Catch \textrm{N typelist} Pokémon} above.
     \item \textit{Evolve \textrm{N typelist} Pokémon}. See \textit{Evolve \textrm{N} Pokémon}
       and \textit{Catch \textrm{N typelist} Pokémon} above.
    \item \textit{Win \textrm{N} raids}. The raids can be the same species.
      Remote raids count.
      Max Battles do not count.
      Successfully catching the Pokémon is not necessary.
  \item \textit{Make \textrm{N quality} throws}.
      Throws of a higher quality than that specified count.
      Throwing $M$ sufficient quality times in a single encounter counts for $M$.
      Successfully catching the Pokémon is not necessary.
  \item \textit{Use \textrm{N} Berries to help catch Pokémon}.
      All Berry types count.
      Using $M$ Berries can count for $M$.
      Use is credited when the Pokémon is caught, when it runs away, or
       when it breaks out of the ball.
      If the Trainer leaves the encounter, any active Berry is not credited,
       but can be credited if the encounter is restarted.
 \item \textbf{MORE...}
\end{itemize}
