...
Max Particles from Research are not subject to this restriction, nor are Max Particle Packs---available
 from the Shop (individually, or in packs of three), each contains 800 MP\@.
...
\begin{itemize}
  ...
  \item \textbf{Today:} Field research---short-term (usually) tasks acquired by spinning Pokéstops.
    ...
    Up to five field research tasks can be active at a time.
...
Individual field research items can be dismissed if you don't want to complete them.
