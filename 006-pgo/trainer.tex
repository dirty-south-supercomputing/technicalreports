...
\caption[Requirements for Trainer Levels 41--50]{Requirements for Trainer Levels 41--50.
   ...
   must be accomplished after the challenge has been unlocked.}
...
\section{Capacities and initial inventories}
...
\begin{tcolorbox}[enhanced,title=Living Pokédexen,halign title=flush center]
Some extreme collectors maintain ``living Pokédexen'', i.e. one of each
  species/form in their usable Pokémon storage.
I suppose you never know when you'll need Emolga.
\end{tcolorbox}
...
As I write this about four months later, I have caught 24,545 Pokémon, of which
  I have retained 441---a little less than 1.8\%.
