...
\begin{figure}[h]
  \begin{minipage}[t]{0.3\textwidth}
    \begin{center}
    \includegraphics[scale=.4]{images/luckyegg.png}
    \end{center}
    \caption*{Lucky egg}
    \label{fig:luckyegg}
  \end{minipage}
  \begin{minipage}[t]{0.3\textwidth}
    \begin{center}
    \includegraphics[scale=.4]{images/stardust.png}
    \end{center}
    \caption*{Stardust}
    \label{fig:stardust}
  \end{minipage}
  \begin{minipage}[t]{0.3\textwidth}
    \begin{center}
    \includegraphics[scale=.4]{images/starpiece.png}
    \end{center}
    \caption*{Star piece}
    \label{fig:starpiece}
  \end{minipage}
...
\begin{figure}[h]
  \begin{minipage}[t]{0.3\textwidth}
    \begin{center}
    \includegraphics[scale=.4]{images/rarecandy.png}
    \end{center}
    \caption*{Rare candy}
    \label{fig:rarecandy}
  \end{minipage}
  \begin{minipage}[t]{0.3\textwidth}
    \begin{center}
    \includegraphics[scale=.4]{images/rarecandyxl.png}
    \end{center}
  ...
  \begin{minipage}[t]{0.3\textwidth}
    \begin{center}
    \includegraphics[scale=.4]{images/pokecoin.png}
    \end{center}
    \caption*{Pokécoin}
    \label{fig:pokecoin}
  \end{minipage}
...
\subsection{Collecting Pokecoins}
