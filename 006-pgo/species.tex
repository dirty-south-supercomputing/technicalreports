\chapter{Species}
Every Pokémon is of some species, identified by its own Pokédex number.
...
Form is usually merely a visual distinction, but it is sometimes reflected
 in stats (e.g. Mega forms have a higher ATK than their base forms)
 or even typing.
All Pokémon of a given form share the same base Attack (ATK), Defense (DEF), and
 Stamina (STA) statistics.
These statistics are always positive integers.

Common forms include:
\begin{itemize}
  \item Mega, a temporary form with greater ATK (see \autoref{section:mega}).
...
\section{Evolution}
Certain species can, under the correct conditions, evolve into others.
