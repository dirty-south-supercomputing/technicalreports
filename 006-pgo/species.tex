...
\end{tabular}
  \caption[Gender-dependent evolutions]{Gender-dependent evolutions.\\Male Combee and male Salandit cannot evolve.\label{table:sexevolutions}}
\end{table}
...
\subsection{Furfrou\label{subsec:furfrou}}
...
They are the initial partner Pokémon from \textit{Sword and Shield}.
\end{tipbox}
