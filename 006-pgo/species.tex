...
Meowstic and Indeedee have different possible attacks based on their gender,
 ...
 species: ``Nidoran♂'' and ``Nidoran♀''\footnote{Leading to some interesting questions about Nidoran biology.}.
\begin{table}
\footnotesize
\centering
\begin{tabular}{lll}
...
\end{tabular}
\caption[Gender-dependent evolutions]{Gender-dependent evolutions.\\Male Combee and male Salandit cannot evolve.}
...
\section{Regions, generations, myths, legends, and beasts}
\label{sec:regions}
