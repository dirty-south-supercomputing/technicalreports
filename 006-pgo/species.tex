...
\input{out/hetero}
Almost all evolutions require that genus's Candy\footnote{Zygarde is an exception.}; evolution beyond Level 40 also requires Candy XL\@.
...
\begin{center}
  \begin{tabular}{lll}
    ...
    Zygarde 50\% & 200 Zygarde Cubes & Zygarde 100\% \\
  \end{tabular}
\end{center}
