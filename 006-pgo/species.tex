...
Evolution infrequently changes the cost group---always in the more expensive direction (\autoref{table:heterocost}).
\input{out/hetero}
...
\begin{tcolorbox}[enhanced,title=``Kanto Starters'',halign title=flush center]
