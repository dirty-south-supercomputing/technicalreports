...
\textbf{infobox for each species still needs: genus, evolves from, evolves to, geommean, optimal1500, optimal2500,
           requirements to evolve, catch rate, flee rate, region, generation, shadow?, shiny?, dmax?,
           pokédex entry, all images need transparent backgrounds}
