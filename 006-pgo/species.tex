...
\end{tabular}
\caption{Gender-dependent evolutions.\\
(Male Combee and Salandit cannot evolve)}
...
\begin{tabular}{lll}
  ...
  Bisharp	& 100 Pawniard Candy + defeat 15 Dark- or Steel-type raids & Kingambit\\
  Primeape & 100 Mankey Candy + defeat 30 Psychic- or Ghost-type& Annihilape\\
  Floette	& 100 Flabébé Candy + earn 20 hearts & Florges\\
  Charcadet	& 50 Charcadet Candy + defeat 30 Psychic-type& Armarouge\\
  Charcadet	& 50 Charcadet Candy + defeat 30 Ghost-type& Ceruledge\\
...
The tricky fox Zorua copies your Buddy Pokémon when it spawns; if you have no Buddy
...
\subsection{Meltan}
\label{subsec:meltan}
Meltan only appears when the Mystery Box is in use, and at the end of the ``Let's GO, Meltan''
  Special Research.
...
\subsection{Gimmighoul}
\label{sec:gimmighoul}
As this requires playing something called \textit{Pokémon Scarlet} or \textit{Pokémon Violet},
  which I never have, I can't speak to Gimmighoul with any authority.
Sorry!
