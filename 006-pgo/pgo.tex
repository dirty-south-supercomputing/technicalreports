...
Historically, base statistics are rarely manipulated, but forms gain
 the ability to learn new attacks.
\vfill
...
\clearpage
\input{out/species}
\vfill{\centering\includegraphics[width=\linewidth,keepaspectratio]{images/greninja.png}}\vfill
