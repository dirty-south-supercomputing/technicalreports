...
\AddToHook{shipout/background}{%
  \ifbool{inspeciesappendex}
    {\ifbool{inspeciesappendex2}
        {\put (0in,-\texpaperheight){\stepcounter{speciesappendixpage}\includegraphics[scale=2,width=\paperwidth,height=\paperheight]{images/backgrounds/\arabic{speciesappendixpage}.pdf}}}
