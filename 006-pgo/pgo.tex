...
\AddToHook{shipout/background}{%
  \ifbool{inspeciesappendex}
    {\ifbool{inspeciesappendex2}
      {\put (0in,-\paperheight){\stepcounter{speciesappendixpage}\includegraphics[scale=2,width=\paperwidth,height=\paperheight]{images/backgrounds/\arabic{speciesappendixpage}.pdf}}}
      {}}
    {\booltrue{inspeciesappendex2}}
}
...
\textbf{infobox for each species still needs: evolves from, evolves to,
           requirements to evolve, catch rate, flee rate, region, generation, dmax?,
