...
\AddToHook{shipout/background}{%
  \ifbool{inspeciesappendex}
    %{\ifbool{inspeciesappendex2}
      ...
      {\adjustbox{trim=\paperwidth 0pt}{\includesvg[width=2\paperwidth,height=\paperheight]{images/backgrounds/\arabic{speciesappendixpage}.svg}}}
      {\stepcounter{speciesappendixpage}\adjustbox{trim=\paperwidth 0pt}{\includesvg[width=2\paperwidth,height=\paperheight]{images/backgrounds/\arabic{speciesappendixpage}.svg}}}
      }}
