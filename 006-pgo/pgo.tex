...
Interpreting a form card:
\begin{speciesbox}[title=Space Shuttle Challenger,title style={left color=red,right color=blue},after title={\hfill 200 120 100 140.00 133.89}]
\footnotesize
