...
\stepcounter{speciesappendixpage}
\AddToHook{shipout/background}{%
  \ifbool{inspeciesappendex}
    %{\ifbool{inspeciesappendex2}
      ...
      % this seems correct
      {\adjustbox{viewport=\paperwidth \paperheight 2\paperwidth 0pt}{\includesvg[width=2\paperwidth]{images/backgrounds/\arabic{speciesappendixpage}.svg}}}
      % places it too low FIXME
      %{\adjustbox{viewport=0pt \paperheight \paperwidth 0pt}{\includesvg[width=2\paperwidth]{images/backgrounds/\arabic{speciesappendixpage}.svg}}}
      {\stepcounter{speciesappendixpage}}
      }}
