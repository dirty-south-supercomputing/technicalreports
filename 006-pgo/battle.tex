...
Color & Requires Fire, Water, Grass, or Electric\\
Electric & Requires Electric\\
Element & Requires Fire, Water, or Grass; prohibits anything evolved\\
Evolution & Must have evolved once, but not be fully evolved\\
Fantasy & Requires Dragon, Fairy, or Steel\\
Fighting & Requires Fighting; prohibits Psychic\\
Flying & Requires Flying\\
Fossil & Requires Rock, Steel, or Water\\
Halloween & Requires Bug, Dark, Fairy, Ghost, or Poison; prohibits Legendary and Mythical\\
Holiday & Requires Electric, Flying, Ghost, Grass, Ice, or Normal\\
Jungle & Requires Bug, Dark, Electric, Flying, Grass, Ground, Normal, or Poison\\
Little & Max CP of 500; must be able to evolve; prohibits anything evolved\\
Love & Requires red or pink coloring\\
Mountain & Requires Ground, Ice, Rock, or Steel\\
Psychic & Requires Psychic; prohibits Mew\\
Retro & Prohibits Dark, Fairy, and Steel\\
Scroll & Requires Dark, Fighting, or Water\\
Single-type & Prohibits dual typing\\
Spring & Requires Fairy, Grass, or Water\\
Summer & Requires Bug, Electric, Fire, Grass, Normal, or Water\\
Sunshine & Requires Fire, Grass, Ground, or Normal\\
Weather & Requires Fire, Ice, Rock, or Water\\
Willpower & Requires Dark, Fighting, or Psychic\\
\end{tabular}
