...
While the egg is present, the gym cannot be assaulted.
...
If further Trainers show up, they will enter a new lobby, and fight their own instance of the boss.
...
The pass is consumed once the raid starts, but involved Trainers can reattempt a failed raid without a second pass.
