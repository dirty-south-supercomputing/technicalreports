...
Item & Effect \\
\Midrule
Potion \includegraphics[width=1em]{images/Potion.png} & +20 HP\\
Super Potion \includegraphics[width=1em]{images/superpotion.png} & +50 HP\\
Hyper Potion \includegraphics[width=1em]{images/Hyper_Potion.png} & +200 HP\\
Max Potion \includegraphics[width=1em]{images/Max_Potion.png} & MHP\\
Revive \includegraphics[width=1em]{images/revive.png} & Revive with half MHP\\
Max Revive \includegraphics[width=1em]{images/maxrevive.png} & Revive with MHP\\
\end{tabular}
\end{center}
