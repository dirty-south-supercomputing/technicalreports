...
Rating is based on an Elo-like system, and resets each season.
A Trainer's rank and rating are shared across all that season's Leagues and Cups.
Trainers will be matched against Trainers with similar ratings.
The self-correcting system rewards upset wins and penalizes upset losses.
