...
\begin{align*}
  Mod_A &< \frac{5}{6}Mod_D: the average goes down\\
  Mod_A &= \frac{5}{6}Mod_D: the average is unchanged\\
  Mod_A &> \frac{5}{6}Mod_D: the average goes up\\
\end{align*}
