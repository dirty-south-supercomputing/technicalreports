...
These tasks must be completed within a year's time; once accomplished, the Pokémon acquires the new IV.
...
\centering
\begin{tabular}{rlll}
Target IV & \IV{A} wins & \IV{D} & \IV{S}\\
  1 & Gym battle & Buddy snapshot & Spin Photodisc\\
  2 & Team GO Rocket Grunt & Play with Buddy & Earn a Candy walking Buddy\\
\end{tabular}
