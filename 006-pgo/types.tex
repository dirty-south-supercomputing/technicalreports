...
\begin{table}[ht]
  ...
  \includegraphics[width=1em]{images/normal.png} &
    ...
    \rowcolor{Gray!25}
    \includegraphics[width=1em]{images/flying.png} & 1 & & & -1 & & 1 & & & & 1 & & & & & & -1 & -1 & \\ % 5
...
With regards to dual typing, it is not possible to dual type using a single
  Type, and ordering does not matter.
\[ C(18, 2) = \binom{18}{2} = \frac{18!}{2!16!} = 153 \]
There are thus 153 dual types in addition to the 18 base types,
  for a total of 171.
Nine are currently unpopulated (Normal/Steel, Normal/Ice, Normal/Rock,
...
There are now 3,078 (18 * 171) relations of which only 1499 (48.7\%) are standard.
...
\begin{table}[ht]
  ...
  \begin{tabular}{l r r r r r r r r r r r}
    ...
    & \multicolumn{4}{c}{\dotfill} & \multicolumn{7}{c}{\downbracefill} \\
