...
Of these, only Dragon and Ghost are
  self-effective\footnote{I use the mnemonic ``Goddamnit!'', as in e.g.
...
Thankfully, the rules thus far give you 70 of the 120 relationships.
Normal isn't strong against anything, and is weak against Rock and Steel.
At the same time, only Fighting is strong against Normal.
That's 73.
\begin{figure}[ht]
\centering
\includegraphics[scale=.25]{out/circo/nature.dot.png}
\caption{The 17 Natural relations}
\end{figure}
...
Ghost is strong against Psychic; the only other type 
