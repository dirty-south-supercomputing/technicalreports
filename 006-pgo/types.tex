...
A majority \textbf{FIXME: verify} of Pokédex have dual typing, but the
  diversity of typing means no dual type has much of a population.
The only ones with ten or more members are Ground+Water, Flying+Normal,
  Bug+Poison, Grass+Ghost, Grass+Poison, Rock+Water, and Bug+Flying.
Meanwhile, all monotypes have at least ten members except for Steel (9)
  and Flying (4).
  \textbf{FIXME: table with populations x 18 types}
