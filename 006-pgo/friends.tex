...
Shadow Pokémon, current Buddy Pokémon, Pokémon defending gyms or Power Stops, and Pokémon
 in Mega, Primal, Fused, or Crowned forms (\autoref{chap:megmax}) are also excluded from trading.
...
A non-obvious application of trading is the ``mirror trade'', where the
 same two Pokémon exchanged are of the same species.
Thanks to trades regenerating IVs, this is one of the only ways to improve IVs of rare Pokémon,
 especially when trading atop a high IV floor.
