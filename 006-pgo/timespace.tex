...
At any given time, the Trainer is in either day or night, corresponding to
 local sunrise and sunset.
Additionally, for an hour prior to and an hour following sunset, the
 Trainer is considered to be in dusk.
Certain evolutions (\autoref{table:condevolutions}) can only take place during
...
Blaze Breed Paldean Tauros, Stakataka, East Sea Shellos, Red-striped Basculin, Solrock & Eastern hemisphere\\
\rowcolor{Gray!25}
...
Uxie, Pansage, Blue Flabébé, Oricorio Sensu, Stretchy Tatsugiri, Xurkitree & East Asia, the Pacific\\
\rowcolor{Gray!25}
Mesprit, Pansear, Red Flabébé, Pheromosa, Oricorio Baile & EMEA, India\\
Curly Tatsugiri & EMEA, West Asia\\
\rowcolor{Gray!25}
Azelf, Panpour, Yellow Flabébé, Buzzwole, Droopy Tatsugiri & Americas\\
...
Pokémon GO operates on scheduled ``Seasons'' of approximately ninety days.
Event themes tend to tie into the season.
The pools for wild spawns (\autoref{sec:spawns}), eggs (\autoref{sec:eggs}), raids, GBL rewards,
...
Thursdays are GO Battle Day, allowing Trainers ten sets instead of the usual five, with a substantial Stardust award multiplier.
