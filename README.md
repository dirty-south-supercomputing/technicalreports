...
|---|-------|-------|--------|---------|
|003|Beating that Georgia Heat. Computer control of minkaAire Fans|The remote controls for two [minkaAire Light Wave](https://www.minkagroup.net/f844-sl.html) fans are reverse-engineered and controlled via embedded transceiver.|[Personal](https://nick-black.com/dankwiki/index.php/Hack_on)|2019-06|
