...
\vspace*{1.25in}
\begin{center}
\epigraph{Update, 2021-06-29: This edition was completed in March 2020. Since
then, great swaths of the Notcurses API have changed. Many if not most of the
examples and references in this text are no longer completely accurate. Read
with caution! I'll update it when I get the chance, ideally by the end of
2021.}{nick black aka dank}
\end{center}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\includegraphics[width=.65\linewidth]{media/chunli-box-front.png}
  \caption[A rendered scene from the ``chunli`` demo.]{A rendered scene from the ``chunli'' demo (see Chapter~\ref{sec:ncdemo}),
