...
\small{This edition of \textit{HTPwNotcurses} corresponds to version 1.2.2 of the Notcurses
...
``cloud''-based Timers as a Service (TaaS) or something.
...
\begin{figure}
  ...
  \end{minipage}
  \caption{A bit of space and color go a long way.}
\end{figure}

% this basically just repeats -draw.h
%\begin{listing}[!htbp]
%\inputminted[]{C}{code/tetrimino-drawnice.h}
%\caption{A little algebra unpacks the pieces (from~\texttt{tetrimino-input.c}).}
%\label{list:tetrimino-drawnice}
%\end{listing}
...
\textbf{FIXME FIXME escapes, other stuff}
...
\begin{figure}
    ...
    \caption{The \texttt{notcurses-demo} menu, unrolled \textit{in media res}. Luigi, pursued
...
\begin{figure}
  ...
  \begin{minipage}{0.45\textwidth}
    ...
    \caption{``Intro''. Lerps on the perimeters. Inverse radial
...
\begin{figure}
  ...
  \caption{``Jungle''. Palette-indexed image. Very low-bandwidth animation via palette cycling.\\
