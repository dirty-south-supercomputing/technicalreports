...
complicates reliable codes. These examples cannot be considered examples
...
\begin{figure}[!htbp]
\centering \includegraphics[width=.5\linewidth]{media/tetrominos.png}
...
\bgroup
\inputminted[linenos,fontsize=\scriptsize,breaklines=true]{C}{code/nckeys.h}
\egroup
