...
``Ruins with Rain'' is property of Mark Ferrari/Living Worlds.
``WarMECH'' is property of Square Enix Co Ltd.
``Luigi'' is property of Nintendo of America.
...
\begin{figure}
  ...
  \begin{minipage}{0.45\textwidth}
    ...
    \caption{``X-Ray''. Streaming of video.
...
\begin{figure}
  ...
  \begin{minipage}{0.45\textwidth}
    ...
    \caption{``Eagle'', early. Parallax scrolling on large image.}
  \end{minipage}\hfill
  \begin{minipage}{0.45\textwidth}
    \includegraphics[width=1\linewidth]{media/demoeagle1.png}
    \caption{``Eagle'', late. Sprites. Zoomed image.}
  \end{minipage}
\end{figure}
