...
\begin{figure}
  ...
  \begin{minipage}{0.5\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{media/selector1.png}
    \caption{Selector with a long title.}
  \end{minipage}\hfill
  \begin{minipage}{0.5\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{media/selector2.png}
...
\begin{figure}
  ...
  \begin{minipage}{0.5\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{media/selector3.png}
    \caption{Selector with a long header.}
  \end{minipage}\hfill
  \begin{minipage}{0.5\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{media/selector4.png}
    \caption{Selector with a long footer.}
  \end{minipage}
\end{figure}

\begin{figure}
  \centering \includegraphics[width=.5\linewidth]{media/selector5.png}
