...
purchased from Apple or Microsoft? Look, I can speak to it! Cortana, diminish my
...
\begin{figure}
  ...
  \begin{minipage}{0.30\textwidth}
    ...
    \caption{First, a gradient on the selected piece.}
  \end{minipage}\hfill
  \begin{minipage}{0.30\textwidth}
    \includegraphics[width=1\linewidth]{media/tetrimino-gradient2.png}
    \caption{Linear addition of space.}
  \end{minipage}
  \begin{minipage}{0.30\textwidth}
    \includegraphics[width=1\linewidth]{media/tetrimino-gradient1.png}
  \end{minipage}\hfill
  \caption{Trigonometric layout.}
\end{figure}
