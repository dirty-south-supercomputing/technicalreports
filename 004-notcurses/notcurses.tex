...
\begin{center}
  ...
  \vspace{.25in}
  \textit{For Coach Jeanette Martin, for exhortations to go H.A.M.} \\
  \vspace{.25in}
  \textit{For Jim Greenlee, for introducing rigor to my programming.\\
  \vspace{.25in}
...
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{So what's all this, then?}
