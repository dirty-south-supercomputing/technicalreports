...
\vspace{1in}
\begin{center}
\includegraphics[width=.8\linewidth]{htp-with-notcurses.png}
\end{center}
\thispagestyle{empty}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
You can write ass code in any interface.},
...
be built using NCURSES, as seen in Figure~\ref{fig:ncurses-tuis}.
...
addition, you can restart the demo with Ctrl+R, or quit at any time (q).
...
Some Relevant terminfo capabilities are described in~\ref{table:terminfo}.
...
The following images were taken using a 80x45 \texttt{xfce4-terminal} 0.8.9.1
from Xfce 4.14 using Xorg 1.20.7. The terminal type is \texttt{xterm-256color},
and \texttt{COLORTERM} is defined to be \texttt{24bit}.
...
\begin{figure}
  ...
  \begin{minipage}{0.45\textwidth}
    ...
    \caption{``Whiteout''. Translucency. Emoji.}
  \end{minipage}\hfill
\end{figure}
...
\begin{figure}
  ...
  \begin{minipage}{0.45\textwidth}
    ...
    \caption{``Uniblock''. Emoji/pictographs.}
  \end{minipage}\hfill
\end{figure}
