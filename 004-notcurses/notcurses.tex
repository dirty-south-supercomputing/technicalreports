...
\begin{denseitemize}
\item{Notcurses doesn't have to \texttt{write()} the data (memory copy)\ldots}
\item{The terminal doesn't have to \texttt{read()} the data (memory copy)\ldots}
\item{The terminal doesn't need to process the data (assorted work)\ldots}
\item{The terminal doesn't need to write to the display (memory copy)\ldots}
\end{denseitemize}
