...
Mark Z. Danielewski's experimental 2000 novel \textit{House of Leaves} prints each
...
e.g. \texttt{print()} (what happens if we're redirect to a file, and
...
distance\footnote{This would be a good place to employ gamma correction.}. If
we wanted to do this without direct use of RGB color, we'd either need accept
fewer shades, or be forced to reprogram the palette.
