...
originally introduced as part of Mary Ann Horton's\footnote{Previously Mark
Horton.} AT\&T curses\cite{horton1982}.

\textbf{FIXME}

The terminfo database and API are specified in SUS, much like Curses (and indeed
the libtinfo installed on most Linux machines is shipped as part of NCURSES).
