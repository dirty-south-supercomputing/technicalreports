...
\caption{Throwing in a background. Despite this being called \textit{after}
  creation of the pieces, it does not hide them, because the loaded image
  is being rendered to the standard plane, which is underneath the pieces
  (from~\texttt{tetrimino-input.c}).}
