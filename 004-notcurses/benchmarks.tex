...
\begin{table}
  ...
  \begin{tabular}{|l|l|l|l|p{.4\textwidth}|}
    \hline
    Emulator & Deb & \texttt{TERM} & Comments \\
    \hline
    \hline
    \texttt{xfce4-terminal} & 0.8.9.1 & vte-256color & \makecell{\texttt{xfce4-terminal} is based on GNOME's VTE\cite{gnomevte},\\
      as are a great many other distro-rebranded terminals.} \\
    \hline
    \texttt{xterm} & Patch \#353 & xterm-256color & See note above regarding regression\\
      to bitmapped fonts, yuck. \\
    \hline
    \texttt{kitty} & 0.15.0 & xterm-kitty & OpenGL-based, Python \\
    \hline
    \texttt{alacritty} & 0.5.0-dev (1ddd311) & alacritty & OpenGL-based, Rust \\
    \hline
