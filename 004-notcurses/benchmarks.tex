...
\begin{table}
  \centering
  \begin{tabular}{|l|l|l|l|p{.4\textwidth}|}
    \hline
    Emulator & Deb & Arch & \texttt{TERM} & Comments \\
    \hline
    \hline
    xfce4-terminal & 0.8.9.1 & 0.8.9.1 & vte-256color & \texttt{xfce4-terminal} is based on GNOME's VTE\cite{gnomevte}, as are a great many other distro-rebranded terminals. \\
    \hline
    xterm & Patch \#353 & Patch \#353 & xterm-256color & See note above regarding regression to bitmapped fonts, yuck. \\
    \hline
    kitty & 0.15.0 & 0.15.0 & xterm-kitty & OpenGL-based, Python \\
    \hline
    alacritty & 0.5.0-dev (1ddd311) & 0.4.1-dev (4d3f6de) & alacritty & OpenGL-based, Rust \\
    \hline
...
to play it safe). Benchmarks always ran on the active desktop. \texttt{cron} was
