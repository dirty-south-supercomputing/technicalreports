...
\caption[Intel i7-8550U benchmarks, varying widths.]{\texttt{notcurses-demo} runtime against terminal width. The font is Hack 10, except on xterm, which was unusable without bitmapped fonts. Linux 5.5.2 + i915, Arch Xorg 1.20.7, no false delay. 1920x1080 Lenovo T580 laptop. LOGARITHMIC Y.}
...
\caption[Bytes output per demo per term.]{Bytes emitted on a 80x52 geometry, 3440x1440 Dell U3417W. LOGARITHMIC Y.}
\label{fig:nvidia-full}
\end{figure}
